...
Once signed up, obtain an API key from the [Dashboard](https://dashboard.naturallink.ai). This key allows the action to communicate with our servers.

### 3. Store the API key as a GitHub Secret

Add your NaturalLink API key as a secret in your GitHub repository (or organization):
